module.exports = Object.freeze({
	...
	PRODUCT_SEARCH_BY_CODE: 'SELECT * FROM Product WHERE code = ? ORDER BY code ASC',
	PRODUCT_SEARCH_BY_ID: 'SELECT * FROM Product WHERE id = ? ORDER BY code ASC',
	PRODUCT_SEARCH_BY_WAREHOUSE_CODE: 'SELECT * FROM Product WHERE warehouse_code = ? ORDER BY code ASC',
	PRODUCT_SEARCH_BY_CODE_AND_WAREHOUSE_CODE: 'SELECT * FROM Product WHERE code = ? AND warehouse_code = ? ORDER BY code ASC',
